...
var gameOptions = {
  ...
  'secretBird': {},
  'answerStatus': false,
  'birdsData': dataTranslate.lang === 'en' ? birds_en : birds
};
...
function checkAnswer(answer) {
  ...
  if (!gameOptions.answerStatus) {
    if (answer.textContent === gameOptions.secretBird.name) {
      ...
      score.textContent = "".concat(dataTranslate[dataTranslate.lang].scoreName, " ").concat(gameOptions.score);
...
function chooseAnswer() {
  ...
  answerRow.addEventListener('click', function (e) {
    if (e.target && e.target.classList.contains('game__answer-item')) {
      ...
      gameOptions.birdsData[gameOptions.gameMode - 1].forEach(function (bird) {
...
function popupOpen() {
  ...
  if (gameOptions.score === 30) {
    audioVictory.play();
    popupScore.textContent = "".concat(dataTranslate[dataTranslate.lang].winText);
    restartBtn.style.display = 'none';
  } else {
    popupScore.textContent = "".concat(dataTranslate[dataTranslate.lang].scoreText, " ").concat(gameOptions.score, "/30");
  }
}
